...
export function BookingForm() {
  ...
  const labels = {
    ...
    desc: { ka: 'შეავსეთ ფორმა და ჩვენ 15 წუთში დაგიკავშირდებით.', en: 'Fill the form and we will contact you within 15 minutes.', ru: 'Заполните форму, и мы свяжемся с вами в течение 15 минут.', uk: 'Заповніть форму, и мы зв\'яжемося з вами протягом 15 хвилин.', ar: 'املأ النموذج وسنتصل بك في غضون 15 دقيقة.', he: 'מלאו את הטופס ונחזור אליכם תוך 15 דקות.' },
    ...
    secure: { ka: 'უსაფრთხო დაჯავშნა. წინასწარი გადახდის გარეშე.', en: 'Secure booking. No prepayment required.', ru: 'Безопасное бронирование. Без предоплаты.', uk: 'Безпечне бронювання. Без переідплати.', ar: 'حجز آمن. لا يلزم دفع مسبق.', he: 'הזמנה מאובטחת. אין צורך בתשלום מראש.' }
  };
